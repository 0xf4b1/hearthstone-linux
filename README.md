...
```
<details>
  <summary>Are you experiencing the issue 'Temporary failure in name resolution'?</summary>

The problem is probably related to your DNS. Make sure to change your DNS to `(8.8.8.8 \ 8.8.4.4)` and run the following commands:
